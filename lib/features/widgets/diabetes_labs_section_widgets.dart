...
class _AddDiabetesDialogState extends State<AddDiabetesDialog> {
  ...
  void _submit() async {
    ...
    final item = DiabetesLabs(
      ...
      fbiGlu: fbgCtrl.text.isEmpty ? null : double.tryParse(fbgCtrl.text.trim()),
      hrsPpBiGlu: ppCtrl.text.isEmpty ? null : double.tryParse(ppCtrl.text.trim()),
      hba1c: hba1cCtrl.text.isEmpty ? null : double.tryParse(hba1cCtrl.text.trim()),
      cPeptide: cPeptideCtrl.text.isEmpty ? null : double.tryParse(cPeptideCtrl.text.trim()),
      insulinLevel: insulinCtrl.text.isEmpty ? null : double.tryParse(insulinCtrl.text.trim()),
      rbs: rbsCtrl.text.isEmpty ? null : double.tryParse(rbsCtrl.text.trim()),
      homaIr: homaCtrl.text.isEmpty ? null : double.tryParse(homaCtrl.text.trim()),
