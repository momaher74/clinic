                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: const [
                            ...
                            SizedBox(width: 8),
                            Text('Add EUS', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
                          ],
                        ),
                      ),
                    ),
                          ...
                          children: [
                            ...
                            const Padding(
                              ...
                              child: CircleAvatar(
                                ...
                                child: Icon(Icons.monitor_heart, color: Color(0xFF9B59B6)),
                              ),
                            ),
                            const SizedBox(width: 12),
                            Expanded(
                            ...
                            Padding(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () => context.read<EusCubit>().delete(item.id!),
                                tooltip: 'Delete',
                              ),
                            ),
                          ],
  ...
  void _showAddDialog(BuildContext context) {
    showDialog(
      ...
      builder: (dialogContext) => MultiBlocProvider(
        providers: [
          BlocProvider.value(value: context.read<EusCubit>()),
        ],
                              ...
                              child: const Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(width: 10),
                                    Text('Add EUS', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 16)),
                                  ],
                                ),
                              ),
                            ),
