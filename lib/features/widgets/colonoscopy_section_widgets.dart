...
class ColonoscopySection extends StatelessWidget {
  ...
  const ColonoscopySection({super.key, required this.patient});

  @override
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      try {
        context.read<ColonoscopyC>().loadForPatient(patient.id!, force: true);
      } catch (_) {}
    });

    return BlocBuilder<ColonoscopyC, ColonoscopyState>(
...
class _ColonoscopyAddDialog extends StatefulWidget {
  final int patientId;

  const _ColonoscopyAddDialog({required this.patientId});

  @override
  State<_ColonoscopyAddDialog> createState() => _ColonoscopyAddDialogState();
}

class _ColonoscopyAddDialogState extends State<_ColonoscopyAddDialog> {
  ...
  void _submit() async {
    ...
    try {
      ...
      print('Error adding Colonoscopy: $e');
    }
  }
